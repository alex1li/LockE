...
class ViewController: UIViewController,CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBAction func unwindToFromDone(sender: UIStoryboardSegue) {
        if (Peripheral.peripheralChosen){
            ...
            disconnectButtonOutlet.tintColor = UIColor(colorLiteralRed: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0)
    }
    }
    ...
    /*
    @IBAction func menuButtonTouchUp(_ sender: UIButton) {
        print("button clicked")
        let popOverVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "sbPopUpId") as! TableViewController
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        //self.upSlider.transform = CGAffineTransform(rotationAngle:CGFloat(Double.pi/2));
        ...
        disconnectButtonOutlet.tintColor = UIColor.clear;
    ...
    */
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
        ...
        if let peripheralName = advertisementData[CBAdvertisementDataLocalNameKey] as? String {
            ...
            if (!Peripheral.peripheralNames.contains(peripheralName)){
                let foundPeripheral = Peripheral(name: peripheralName, realPeripheral: peripheral)
